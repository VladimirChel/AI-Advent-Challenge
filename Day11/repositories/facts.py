...
def get_conversation_facts(conversation_id: str, branch_id: str) -> list[StickyFact]:
...
def upsert_facts(conversation_id: str, branch_id: str, facts: list[StickyFact]) -> int:
    if not facts:
        return 0
            ...
            for fact in facts:
                cur.execute(
                    ...
                    INSERT INTO conversation_facts (
                        conversation_id, branch_id, key, value, memory_kind, confidence, source, updated_at
                    )
