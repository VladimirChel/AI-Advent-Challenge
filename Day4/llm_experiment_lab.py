...
class App(ctk.CTk):
    ...
    def _build_settings_tab(self) -> None:
        ...
        ctk.CTkLabel(self.settings_tab, text="Модель").grid(row=1, column=0, sticky="w", padx=8, pady=8)
    ...
    def _build_scenarios_tab(self) -> None:
        ...
        ctk.CTkLabel(
            self.scenarios_tab,
            text="Список сценариев в JSON. Один объект = один запрос к модели.",
    ...
    def _build_evaluation_tab(self) -> None:
        ...
        self.eval_max_tokens_var = ctk.StringVar(value="2000")
